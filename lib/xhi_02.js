...
function setupFn () {
  ...
  // BEGIN utility /_00_checkBinListFn/
  function _00_checkBinListFn () {
    var
      ctx_obj      = this,
      exe_list     = [ 'git', 'patch' ],
  ...
  // . END utility /_00_checkBinListFn/
  ...
  // BEGIN utility /_02_copyVendorFilesFn/
  function _02_copyVendorFilesFn () {
    var
      ctx_obj      = this,
  ...
  // . END utility /_02_copyVendorFilesFn/
  ...
  function mainFn () {
    ...
    postObj.flowObj.exec(
      function _step00Fn () {
        ...
        _00_checkBinListFn.call( { then_fn : this, catch_fn : failFn } );
      },
      function _step01Fn () {
      ...
      function _step02Fn () {
        ...
        _02_copyVendorFilesFn.call( { then_fn : this, catch_fn : failFn } );
      },
      function _step03Fn () {

...
function setupFn () {
  ...
  function rmVendorDirsFn () {
    ...
    for ( idx = 0; idx < asset_group_count; idx++ ) {
      ...
      postObj.mkdirpFn.sync( fq_dest_dir_str );
  ...
  function mainFn () {
    ...
    postObj.flowObj.exec(
      ...
      function _02_05_UnlinkHookFn () {
        ...
        postObj.unlinkHookFn.call( { then_fn : this, catch_fn : failFn } );
      },
      function _02_06_LinkHookFn () {
        logFn( '  06: Add latest commit hook...' );
        postObj.linkHookFn.call( { then_fn : this, catch_fn : failFn } );
      },

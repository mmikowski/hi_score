...
function buildFn () {
  ...
  var
    ...
    shellJsObj, postObj, fileJsList,
    fileCssList, subtreeList, copyList,
    uglyJsMap, uglyCssStr
    ;
  // == . END MODULE SCOPE VARIABLES ==================================
  // // BEGIN HACK to test buildify work
  // xhi_obj  = makeXhiObj();
  // stage_fn = require( fqLibDirname + '/xhi_99.js' );
  // stage_fn.call( xhi_obj, {
  // });
  // process.exit( 0 );
  // . END HACK to test buildify work
  ...
  function cleanupFn () {
    ...
    logFn( subtreeList, copyList, uglyJsMap.code, uglyCssStr );
  ...
  function mainFn () {
    ...
    postObj.flowObj.exec(
      ...
      function _11_02_prepBuildDirFn () {
        ...
        prepBuildDirFn.call({ then_fn: this, catch_fn : failFn });
      },

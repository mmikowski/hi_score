...
function upgradeFn () {
  ...
  function onOutdatedFn ( error_data, update_table ) {
    ...
    // TODO: 2017-08-30 mmikowski error: run xhi install here
    // TODO: 2017-08-30 mmikowski error: run xhi setup here
    // Can we invalidate the xhi_state.json record and then
    // insert install and setup into the stage list?
    // A cleaner alternative might be to do a linear prereq insert
    // via the configs. In other words, add a 3rd stage list to
    // config that is inserted as-is in stage
    //
    //
  }

...
hi._utilb_ = (function ( $ ) {
  ...
  // BEGIN Public method |_decodeHtml_|
  ...
  // END Public method |_decodeHtml_|

  // BEGIN Public method |_encodeHtml_|
  ...
  // END Public method |_encodeHtml_|

  // BEGIN Public method |_fillForm_|
  ...
  // END Public method |_fillForm_|

  // BEGIN Public method |_fixInputByType_|
  function fixInputByType ($elem) {
    ...
    if ( $elem.attr('data-type') === 'number' ) {
      ...
      if ( input_val === __blank ) { input_val = __null; }
    }
    return input_val;
  }
  // END Public method |_fixInputByType_|


  // BEGIN Public method |_getFormMap_|
  ...
  // END Public method |_getFormMap_|

  // BEGIN Public method |_makeOptionHtml_|
  ...
  // END Public method |_makeRadioHtml_|

  // BEGIN Public method |_onBufferReady_|
  ...
  // END Public method |_onBufferReady_|
  // ======================= END PUBLIC METHODS =======================

...
xhi._css_shell_ = (function () {
  // ================= BEGIN MODULE SCOPE VARIABLES ===================
  'use strict';
  //noinspection MagicNumberJS
  var
    __blank = xhi._vMap_._blank_,
    topCmap = {
      _selector_list_ : [
        // -- begin xhi-_shell_ selectors
        { _selector_str_ : '.xhi-_shell_head_',
          _rule_map_     : {
            _z_index_     : [ '30' ],
            _position_   : '_fixed_',
        ...
        { _selector_str_  : '.xhi-_shell_head_logo_',
          _rule_map_      : {
        ...
        { _selector_str_  : '.xhi-_shell_head_search_ > input',
          _rule_map_ : {
            _outline_     : '_none_',
            _width_       : '_100p_',
            _height_      : '_2rem_',
        ...
        { _selector_str_  : '.xhi-_shell_head_search_ > input:focus',
          _rule_map_ : { _border_color_ : '_hex_area_mid_dk_' }
        },
        { _selector_str_  : '.xhi-_shell_head_search_ .xhi-_x_mag_',
          _rule_map_ : {
            _position_    : '_absolute_',
            _top_         : '_0_',
            _left_        : '_d625rem_',
        ...
        { _selector_str_ : '.xhi-_shell_umenu_.xhi-_x_open_',
          _rule_map_     : {
            _background_ : '_hex_frame_',
            _box_shadow_ : '_shdw_04_'
          }
        },
        { _selector_str_ : '.xhi-_shell_umenu_>li',
          _rule_map_     : {
            _display_     : '_none_',
            _height_      : '_3rem_',
        ...
        { _selector_str_ : '.xhi-_shell_umenu_.xhi-_x_open_>li',
          _rule_map_     : { _display_ : '_block_' }
        },
        { _selector_str_ : '.xhi-_shell_umenu_>li:first-child',
          _rule_map_ : {
            '_display_'     : '_block_',
            '_line_height_' : '_1d5rem_'
          }
        },
        { _selector_str_ : '.xhi-_shell_umenu_>li div',
          _rule_map_ : {
            _line_height_ : '_1d5rem_',
            _margin_right_ : '_2rem_'
          }
        },
        { _selector_str_ : '.xhi-_shell_umenu_>li:hover',
          _rule_map_ : { _color_ : '_hex_link_lt_' }
        },
        { _selector_str_ : '.xhi-_shell_umenu_>li span',
          _rule_map_ : {
            _display_      : '_block_',
            _float_        : '_right_',
            _height_       : '_3rem_',
        ...
        { _selector_str_ : '.xhi-_shell_tgl_',
          _rule_map_     : {
            _z_index_     : [ '20' ],
            _position_   : '_fixed_',
            _top_        : '_0_',
        ...
        { _selector_str_ : '.xhi-_shell_nav_>li',
          _rule_map_ : {
            _white_space_   : '_nowrap_',
        ...
        { _selector_str_ : '.xhi-_shell_cont_head_bread_ li',
          _rule_map_     : {
            _display_        : '_inline_block_',
            _float_          : '_left_',
            _line_height_    : '_2rem_',
        ...
        { _selector_str_ : '.xhi-_shell_cont_head_bread_ li:nth-child(even)',
          _rule_map_     : {
        ...
        { _selector_str_ : '.xhi-_shell_cont_head_bread_ li:last-child',
          _rule_map_     : {
        ...
        { _selector_str_ : '.xhi-_shell_cont_head_icon_',
          _rule_map_     : {
        ...
        { _selector_str_ : '.xhi-_box_',
          _rule_map_ : { _position_    : '_relative_' }
        },
        { _selector_str_ : '.xhi-_shell_nav_.xhi-_x_open_',
          _rule_map_ : { _width_ : [ '13rem' ] }
        },
        { _selector_str_ : '.xhi-_shell_head_.xhi-_x_open_',
          _rule_map_     : {
            _border_radius_ : [[ '_0_','_0_','_0_','_1rem_' ]]
          }
        },
        { _selector_str_ : '.xhi-_shell_cont_.xhi-_x_open_',
          _rule_map_     : { _padding_left_ : [ '15.25rem' ] }
        },
        // -- end xhi-_shell_ selectors

        // -- begin xhi-_shell_ mid-width conditional selectors
        ...
        { _selector_str_ : '.xhi-_shell_tgl_.xhi-_x_open_',
          _rule_map_ : { _box_shadow_ : '_none_' }
        },
        { _end_cond_str_ : __blank },
        // -- end xhi-_shell_ mid-width conditional selectors

        // -- begin xhi-_shell_ narrow-width conditional selectors
        ...
        { _end_cond_str_ : __blank }
        // -- end xhi-_shell_ narrow-width conditional selectors
      ]
    };
